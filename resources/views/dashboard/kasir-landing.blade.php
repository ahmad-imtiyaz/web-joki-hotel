{{-- File: resources/views/dashboard/kasir-landing.blade.php --}}
...
<div class="welcome-section">
    <div class="container">
        <div class="text-center mb-5">
            <h1><i class="fas fa-hotel me-3"></i>Sistem Kasir Hotel</h1>
            ...
            @forelse($rooms as $room)
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card room-card room-status-{{ $room->status }}" 
                         @if($room->isAvailable()) 
                             onclick="window.location='{{ route('kasir.bookings.create', $room) }}'"
...
function showRoomDetails(roomId) {
    ...
    content += `
        <div class="d-grid">
            <form action="{{ url('/kasir/bookings') }}/${booking.id}/complete" method="POST" 
